...
public class FrmFornecedor extends JFrame {
	...
	*/
	...
	private void alterarFornecedor() {
		...
		limparCampos.Limpar(abaCadastrarFornecedor);
 ...
 */
	...
	/*
Metodo para preencher os campos da tela com os dados do fornecedor selecionado na tabela.
 */
	private void preencherDadosFornecedor(){
		int linha = tabelaFornecedores.getSelectedRow();

		tfNomeFantasia.setText(tabelaFornecedores.getValueAt(linha, 0).toString());
		tfEmail.setText(tabelaFornecedores.getValueAt(linha, 1).toString());
		tfEndereco.setText(tabelaFornecedores.getValueAt(linha, 2).toString());
		tfNumero.setText(tabelaFornecedores.getValueAt(linha, 3).toString());
		tfCnpj.setText(tabelaFornecedores.getValueAt(linha, 4).toString());
		tfBairro.setText(tabelaFornecedores.getValueAt(linha, 5).toString());
		tfCidade.setText(tabelaFornecedores.getValueAt(linha, 6).toString());
		tfCelular.setText(tabelaFornecedores.getValueAt(linha, 7).toString());
		tfTelefone.setText(tabelaFornecedores.getValueAt(linha, 8).toString());
		tfCep.setText(tabelaFornecedores.getValueAt(linha, 9).toString());
		tfComplemento.setText(tabelaFornecedores.getValueAt(linha, 10).toString());
		tfInscricaoEstadual.setText(tabelaFornecedores.getValueAt(linha, 11).toString());
		tfRazaoSocial.setText(tabelaFornecedores.getValueAt(linha, 12).toString());
		cbUf.setSelectedItem(tabelaFornecedores.getValueAt(linha, 13).toString());
	}


	/**
	 * Método utilizado para consultar fornecedores pelo nome ou parte do nome para exibir na tabela.
...
private void consultarFornecedores(){
	...
	public FrmFornecedor() throws ParseException {
		...
		gl_abaConsultarFornecedores.setHorizontalGroup(
				gl_abaConsultarFornecedores.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_abaConsultarFornecedores.createSequentialGroup()
								.addGap(30)
		...
		gl_abaConsultarFornecedores.setVerticalGroup(
				gl_abaConsultarFornecedores.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_abaConsultarFornecedores.createSequentialGroup()
								.addGap(22)
		...
		gl_abaCadastrarFornecedor.setHorizontalGroup(
				gl_abaCadastrarFornecedor.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_abaCadastrarFornecedor.createSequentialGroup()
								...
								.addGroup(gl_abaCadastrarFornecedor.createParallelGroup(Alignment.LEADING)
										...
										.addGroup(gl_abaCadastrarFornecedor.createSequentialGroup()
												...
												.addGroup(gl_abaCadastrarFornecedor.createParallelGroup(Alignment.LEADING)
														.addGroup(gl_abaCadastrarFornecedor.createSequentialGroup()
																.addGroup(gl_abaCadastrarFornecedor.createParallelGroup(Alignment.LEADING, false)
																		.addGroup(gl_abaCadastrarFornecedor.createSequentialGroup()
		...
		gl_abaCadastrarFornecedor.setVerticalGroup(
				gl_abaCadastrarFornecedor.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_abaCadastrarFornecedor.createSequentialGroup()
								.addGap(108)
