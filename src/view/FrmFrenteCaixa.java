...
public class FrmFrenteCaixa extends JFrame{
	...
	/**
	 * Método responsável por realizar a verificação se o coixa está fechado e inicializar uma venda.
	 */
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(produto.getCodigoDeBarras() == null) {
						...
						JOptionPane.showMessageDialog(null, produto.getDescricao() + " - R$: " + produto.getPrecoFinal());						
					}
				} catch (Exception e2) {
