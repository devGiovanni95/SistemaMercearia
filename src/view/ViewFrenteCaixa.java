...
public class ViewFrenteCaixa extends JFrame {
	...
	public ViewFrenteCaixa() {
								...
								.addGroup(groupLayout.createSequentialGroup()
									.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
										.addGroup(groupLayout.createSequentialGroup()
											...
											.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
												.addComponent(panel_1_1_1_3, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(panel_1_1_1_2, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(panel_1_1_1_1, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(panel_1_1_1, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
										.addComponent(panelComandos, GroupLayout.DEFAULT_SIZE, 579, Short.MAX_VALUE))
									.addGap(19))
								.addGroup(groupLayout.createSequentialGroup()
									.addComponent(painelComandos, GroupLayout.DEFAULT_SIZE, 580, Short.MAX_VALUE)
									.addGap(18)))
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addComponent(panel_2, GroupLayout.DEFAULT_SIZE, 577, Short.MAX_VALUE)
								.addComponent(panelComandos_1, GroupLayout.DEFAULT_SIZE, 577, Short.MAX_VALUE))))
					.addGap(50))
		);
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(panel_2, GroupLayout.DEFAULT_SIZE, 400, Short.MAX_VALUE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(panelComandos_1, GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE))
						.addGroup(groupLayout.createSequentialGroup()
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup()
									.addComponent(panel_1_1_1, GroupLayout.DEFAULT_SIZE, 58, Short.MAX_VALUE)
									.addPreferredGap(ComponentPlacement.UNRELATED)
									.addComponent(panel_1_1_1_1, GroupLayout.DEFAULT_SIZE, 58, Short.MAX_VALUE)
									.addPreferredGap(ComponentPlacement.UNRELATED)
									.addComponent(panel_1_1_1_2, GroupLayout.DEFAULT_SIZE, 58, Short.MAX_VALUE)
									.addGap(15)
									.addComponent(panel_1_1_1_3, GroupLayout.DEFAULT_SIZE, 58, Short.MAX_VALUE)
									.addGap(6))
								.addGroup(groupLayout.createSequentialGroup()
		...
		JButton btnNewButton_1_1_1 = new JButton("F1 - Modo Consulta");
		btnNewButton_1_1_1.setFont(new Font("Arial", Font.BOLD, 22));
		
		JButton btnNewButton_1_1_2 = new JButton("F1 - Modo Consulta");
		btnNewButton_1_1_2.setFont(new Font("Arial", Font.BOLD, 22));
		
		JButton btnNewButton_1_1_3 = new JButton("F1 - Modo Consulta");
		btnNewButton_1_1_3.setFont(new Font("Arial", Font.BOLD, 22));
		
		JButton btnNewButton_1_1_4 = new JButton("F1 - Modo Consulta");
		btnNewButton_1_1_4.setFont(new Font("Arial", Font.BOLD, 22));
		
		JButton btnNewButton_1_1_5 = new JButton("F1 - Modo Consulta");
		btnNewButton_1_1_5.setFont(new Font("Arial", Font.BOLD, 22));
		
		JButton btnNewButton_1_1_6 = new JButton("F1 - Modo Consulta");
		btnNewButton_1_1_6.setFont(new Font("Arial", Font.BOLD, 22));
		
		JButton btnNewButton_1_1_7 = new JButton("F1 - Modo Consulta");
		btnNewButton_1_1_7.setFont(new Font("Arial", Font.BOLD, 22));
		
		JButton btnNewButton_1_1_8 = new JButton("F1 - Modo Consulta");
		btnNewButton_1_1_8.setFont(new Font("Arial", Font.BOLD, 22));
		
		JButton btnNewButton_1_1_9 = new JButton("F1 - Modo Consulta");
		...
		gl_panel_1_1_1_1.setHorizontalGroup(
			gl_panel_1_1_1_1.createParallelGroup(Alignment.TRAILING)
				.addComponent(panel_6, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 283, Short.MAX_VALUE)
		);
		...
		gl_panel_1_1_1_3.setHorizontalGroup(
			gl_panel_1_1_1_3.createParallelGroup(Alignment.LEADING)
				.addComponent(panel_8, GroupLayout.DEFAULT_SIZE, 291, Short.MAX_VALUE)
		);
		gl_panel_1_1_1_3.setVerticalGroup(
			gl_panel_1_1_1_3.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1_1_1_3.createSequentialGroup()
					.addComponent(panel_8, GroupLayout.PREFERRED_SIZE, 37, GroupLayout.PREFERRED_SIZE)
					.addContainerGap(19, Short.MAX_VALUE))
		);
		...
		gl_panel_1_1_1.setHorizontalGroup(
			gl_panel_1_1_1.createParallelGroup(Alignment.LEADING)
				.addComponent(panel_5, GroupLayout.DEFAULT_SIZE, 283, Short.MAX_VALUE)
		);
