 ...
 * Define um campo de texto que limita o número de caracteres que o usuário pode inserir.
 * E também pode limitar o tipo de caracteres inseridos baseado no Validador fornecido.
 */
public class TextFieldLimit extends JTextField {
    ...
    public TextFieldLimit(int limit, Validador validador) {
        super();
        // Define o documento do campo de texto para um novo LimitDocument com o limite fornecido e o validador.
    ...
    private class LimitDocument extends PlainDocument {
         ...
         * Cria um novo LimitDocument com o número máximo de caracteres definido e o validador.
         * @param limit O número máximo de caracteres permitidos.
         * @param validador O validador a ser usado para verificar a entrada.
         */
         ...
         * Se a inserção da string exceder o limite ou não passar pelo validador, a string não será inserida.
