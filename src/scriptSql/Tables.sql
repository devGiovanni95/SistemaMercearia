...
create table tb_funcionario(
   ...
   pis_pasep char (11) not null,
   salario money not null,
   carteira_trabalho char (13) not null,
...
create table tb_venda(
  codigo varchar(20) primary key,
  cod_cliente char(14) references tb_cliente,
  ...
  create table tb_item_venda(
   codigo int primary key identity(1,1),
   codigo_produto char (13) references tb_produto,
...
codigo int primary key identity,
cod_produto char (13) references tb_produto,
cod_fornecedor char(18) references tb_fornecedor,
